<div class="flex-1 relative" x-data>
    <form action="{{ route('search') }}" autocomplete="off">
        ...
        <x-input name="name" wire:model="search" type="text" class="w-full" placeholder="¿Estas buscando algo?" />
        ...
        <div class="bg-white rounded-lg shadow mt-1">
            <div class="px-4 py-3 space-y-1">
                ...
                @empty
                    ...
                    <p class="text-lg leading-5">No se encontró ningun prodúcto con los parametros especificados.</p>
                @endforelse
            </div>
        </div>
    </div>
