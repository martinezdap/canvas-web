<div>
    ...
    <div class="grid grid-cols-5 gap-6 container p-8">
                ...
                <div class="grid grid-cols-2 gap-6 text-gray-700">
                    <div>
                        ...
                        @else
                            ...
                            <p class="text-sm">{{ $order->adress }}</p>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6 ">
                <div class="flex justify-between items-center">
                    <div class="text-gray-700">
                        <p class="text-sm font-semibold">Sub total: {{ $order->total - $order->shipping_cost }} USD</p>
                    ...
                    <img class="h-8" src="{{ asset('img/images.png') }}" alt="">
                </div>
